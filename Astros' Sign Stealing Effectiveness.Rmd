...
game_bangs_summary <- bangs_clean %>%
  ...
  left_join(game_results, by = "game_date") %>%
  mutate(result = if_else(astros_score > opponent_score, "Win", "Loss"))


sum(is.na(bangs_clean))
sum(is.na(player_stats_clean))
sum(is.na(game_bangs_summary))
...
# Assuming the data contains lineup position information
# If not, this would need to be adjusted or removed
...
# Assuming the data contains score information
...
# This assumes you have at-bat level data that indicates whether a bang occurred
...
# This assumes pitch-by-pitch data is available
...
# This assumes you have at-bat level data with bang indicators
...
# This is a placeholder - you would need to adjust based on available data

# Create a heatmap of bang frequency by count (balls and strikes)
# Assuming the data contains balls and strikes information
...
# This would require additional data on opposing pitchers
...
In this section, you will summarize your key findings and interpret what they mean in the context of the sign-stealing scandal. Some points to consider:
